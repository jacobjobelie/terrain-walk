...
class GroundView extends alfrid.View {
    ...
    constructor(params = {}) {
        ...
        gui.addColor(this, '_pBase')
        gui.addColor(this, '_pLight')
        gui.addColor(this, '_pDark')
        gui.addColor(this, '_pFog')

        this._createCanvas()

        TerrainManager.init()
        this._heightTexture = new alfrid.GLTexture(TerrainManager.canvas);
        //this._updateMap()
    }
